...
// @version      8.2.0-beta.5-capsule
// @description  为知能行考研数学提供全局毛玻璃视觉升级、回车快捷提交/下一步、Dark Reader 深色模式自适应、Live2D 看板娘(多CDN容灾)与考研倒计时(闲置5秒靠边收纳/拖拽/位置记忆)辅助
// @author       winslght
// @license      MIT
...
(function() {
    ...
    const SCRIPT_VERSION = '8.2.0-beta.5-capsule';
