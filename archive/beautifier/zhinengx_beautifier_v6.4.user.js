...
(function() {
    ...
    function generateBaseCSS() {
        return `
            ...
            /* 进度条保真防护：保持知能行原生的精致矩形 (2px圆角)，绝不强行变为大圆角/胶囊状 */
            html body #root div[style*="linear-gradient"],
            html body #root div[style*="border-radius: 2px"],
            html body #root div[style*="border: 1px solid"],
            html body #root div[style*="border:1px solid"] {
