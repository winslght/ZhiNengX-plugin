...
(function() {
    ...
    function generateBaseCSS() {
        return `
            ...
            /* 只要进入做题界面 (出现 _3WnwfR 顶栏)，自动淡隐底层的蓝色导航条；退出做题时，纯 CSS 零延迟秒级还原！ */
            #root:has(div[class*="_3WnwfR"]) #navigation-pills,
            #root:has(div[class*="_3WnwfR"]) #moduleHeader,
            #root:has(div[class*="_3WnwfR"]) .MuiTabs-root {
                opacity: 0 !important;
